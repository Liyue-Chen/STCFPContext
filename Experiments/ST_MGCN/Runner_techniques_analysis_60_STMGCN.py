...
os.system(bike_shared_params_st_mgcn + ' --City Chicago --external_method emb-not-concat '
                                      '  --MergeIndex 1 --CodeVersion emb_not_concat ')
