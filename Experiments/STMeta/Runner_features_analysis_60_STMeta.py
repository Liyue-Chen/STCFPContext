...
# os.system('python STMeta_Obj.py -m STMeta_v1.model.yml -d bike_chicago.data.yml '
#           '-p external_use:poi,poi_distance:5000,batch_size:16,external_method:not-linear-gating,graph:Distance-Correlation-Interaction,mark:poi')

# os.system('python STMeta_Obj.py -m STMeta_v1.model.yml -d bike_chicago.data.yml '
#           '-p external_use:poi-weather,poi_distance:5000,batch_size:16,external_method:not-linear-gating,graph:Distance-Correlation-Interaction,mark:poi_wea')

# os.system('python STMeta_Obj.py -m STMeta_v1.model.yml -d bike_chicago.data.yml '
#           '-p external_use:poi-holiday,poi_distance:5000,batch_size:16,external_method:not-linear-gating,graph:Distance-Correlation-Interaction,mark:poi_holi')

# os.system('python STMeta_Obj.py -m STMeta_v1.model.yml -d bike_chicago.data.yml '
#           '-p external_use:poi-tp,poi_distance:5000,batch_size:16,external_method:not-linear-gating,graph:Distance-Correlation-Interaction,mark:poi_tp')

# os.system('python STMeta_Obj.py -m STMeta_v1.model.yml -d bike_chicago.data.yml '
#           '-p external_use:poi-weather-holiday,poi_distance:5000,batch_size:16,external_method:not-linear-gating,graph:Distance-Correlation-Interaction,mark:poi_wea_holi')

# os.system('python STMeta_Obj.py -m STMeta_v1.model.yml -d bike_chicago.data.yml '
#           '-p external_use:poi-weather-tp,poi_distance:5000,batch_size:16,external_method:not-linear-gating,graph:Distance-Correlation-Interaction,mark:poi_wea_tp')

# os.system('python STMeta_Obj.py -m STMeta_v1.model.yml -d bike_chicago.data.yml '
#           '-p external_use:poi-holiday-tp,poi_distance:5000,batch_size:16,external_method:not-linear-gating,graph:Distance-Correlation-Interaction,mark:poi_holi_tp')

# os.system('python STMeta_Obj.py -m STMeta_v1.model.yml -d bike_chicago.data.yml '
#           '-p external_use:poi-weather-holiday-tp,poi_distance:5000,batch_size:16,external_method:not-linear-gating,graph:Distance-Correlation-Interaction,mark:poi_wea_holi_tp')
...
# #############################################
# # New dataset Bike NYC and Taxi Chicago
# #############################################
